...
```gradle
dependencies {
    implementation 'com.github.apiverve:silverprice-api:1.1.12'
}
```
...
```java
import com.apiverve.silverprice.SilverPriceAPIClient;
import com.apiverve.silverprice.APIResponse;
import com.apiverve.silverprice.APIException;

// Initialize the client
SilverPriceAPIClient client = new SilverPriceAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/silverprice](https://docs.apiverve.com/ref/silverprice)
...
- **Documentation:** [https://docs.apiverve.com/ref/silverprice](https://docs.apiverve.com/ref/silverprice)
- **Issues:** [GitHub Issues](https://github.com/apiverve/silverprice-api/issues)
