// Package silverprice provides a Go client for the Silver Price API.
//
// For more information, visit: https://silverprice.apiverve.com?utm_source=go&utm_medium=readme
package silverprice
...
const (
	baseURL        = "https://api.apiverve.com/v1/silverprice"
	defaultTimeout = 30 * time.Second
)

// Client is the Silver Price API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Silver Price API client.
...
// Execute makes a request to the Silver Price API with typed parameters.
//
